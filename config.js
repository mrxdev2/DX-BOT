...
const config = {
    ...
    botOwner: process.env.BOT_OWNER || 'MrXDev',
    ownerNumber: process.env.OWNER_NUMBER || '255775710774',
    author: process.env.AUTHOR || 'DARKX-ULTRA',
    ...
    // Links
    channelLink: process.env.CHANNEL_LINK || 'https://chat.whatsapp.com/CH0c5pLLqJnC2LSezaYTVS',
    updateZipUrl: process.env.UPDATE_URL || 'https://github.com/mrxdev2/DarkX-Mini/archive/refs/heads/main.zip',
    ytChannel: process.env.YT_CHANNEL || 'DARKX-ULTRA'
    // Session
